...
\textit{At the Canticle of Mary, antiphon as in the Proper of Seasons}
...
\textit{At the Canticle of Zechariah, antiphon as in the Proper of Seasons}
\section{Sunday, Daytime Prayer}
\gregorioscore{antiphons/psalter/week1/sunday/daytime/ant1}
\gregorioscore{antiphons/psalter/week1/sunday/daytime/ant2}
\gregorioscore{antiphons/psalter/week1/sunday/daytime/ant3}
\section{Sunday, Evening Prayer II}
\gregorioscore{antiphons/psalter/week1/sunday/evening2/ant1}
\gregorioscore{antiphons/psalter/week1/sunday/evening2/ant2}
\gregorioscore{antiphons/psalter/week1/sunday/evening2/ant3}
\textit{At the Canticle of Mary, antiphon as in the Proper of Seasons}

\section{Monday, Office of Readings}
...
\chapter{Complementary Psalmody}
\section{Series I}
\gregorioscore{antiphons/psalter/complementary/midmorning/ant1}
\gregorioscore{antiphons/psalter/complementary/midmorning/ant2}
\gregorioscore{antiphons/psalter/complementary/midmorning/ant3}
\section{Series II}
\gregorioscore{antiphons/psalter/complementary/midday/ant1}
\gregorioscore{antiphons/psalter/complementary/midday/ant2}
\gregorioscore{antiphons/psalter/complementary/midday/ant3}
\section{Series III}
\gregorioscore{antiphons/psalter/complementary/midafternoon/ant1}
\gregorioscore{antiphons/psalter/complementary/midafternoon/ant2}
\gregorioscore{antiphons/psalter/complementary/midafternoon/ant3}
